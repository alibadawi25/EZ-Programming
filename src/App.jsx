...
function App() {
  ...
  return (
    <Layout className="w-screen h-screen" theme="dark">
      ...
      <Sider trigger={null} collapsible collapsed={false} style={{ background: "#141414", padding: "16px", overflow: "auto" }}>
        <div style={{ color: "white", padding: "0 0 16px 0", textAlign: "center", fontWeight: "bold", borderBottom: "1px solid #434343", marginBottom: "16px" }}>
          EZ-Programming
        </div>
